 ...
 * 
 */
@WebService(name = "CalcPrecoPrazoWSSoap", targetNamespace = "http://jogano10.com/")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface CalcPrecoPrazoWSSoap {
    ...
    @RequestWrapper(localName = "CalcPrecoPrazo", targetNamespace = "http://tempuri.org/", className = "com.jogano10.CalcPrecoPrazo")
    @ResponseWrapper(localName = "CalcPrecoPrazoResponse", targetNamespace = "http://tempuri.org/", className = "com.jogano10.CalcPrecoPrazoResponse")
