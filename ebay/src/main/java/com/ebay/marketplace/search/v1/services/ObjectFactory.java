...
public class ObjectFactory {
    ...
    private final static QName _FindItemsByImageResponse_QNAME = new QName("http://www.ebay.com/marketplace/search/v1/services", "findItemsByImageResponse");
    ...
    private final static QName _FindItemsByImageRequest_QNAME = new QName("http://www.ebay.com/marketplace/search/v1/services", "findItemsByImageRequest");
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link FindItemsByImageResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.ebay.com/marketplace/search/v1/services", name = "findItemsByImageResponse")
    public JAXBElement<FindItemsByImageResponse> createFindItemsByImageResponse(FindItemsByImageResponse value) {
        return new JAXBElement<FindItemsByImageResponse>(_FindItemsByImageResponse_QNAME, FindItemsByImageResponse.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link FindItemsByImageRequest }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://www.ebay.com/marketplace/search/v1/services", name = "findItemsByImageRequest")
    public JAXBElement<FindItemsByImageRequest> createFindItemsByImageRequest(FindItemsByImageRequest value) {
        return new JAXBElement<FindItemsByImageRequest>(_FindItemsByImageRequest_QNAME, FindItemsByImageRequest.class, null, value);
    }
